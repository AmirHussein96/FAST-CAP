...
def main():
    ...
    parser.add_argument("--use-comet", action="store_true", help="Also compute COMET scores.")
    parser.add_argument("--comet-ckpt", type=str, default="/lustre/fsw/portfolios/llmservice/users/amhussein/pretrained_models/comet/model.ckpt", help="Path to COMET checkpoint.")
    parser.add_argument("--lower", action="store_true", help="Lowercase ref/hyp before scoring.")
    parser.add_argument("--keep-empty", action="store_true", help="Include empty hypotheses in scoring.")
    parser.add_argument("--rm-punctuation", action="store_true", help="Remove punctuation from ref/hyp before scoring.")
    parser.add_argument("--clean-english-text", action="store_true", help="Clean English text and keep punctuation.")
